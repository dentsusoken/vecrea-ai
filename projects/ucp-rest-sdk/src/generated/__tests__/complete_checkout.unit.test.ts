...
import { Complete_checkoutApi } from '../complete_checkout';
import {
  getRequestSchema,
  getResponseSchema,
  getHeadersSchema,
...
const requestSchema = getRequestSchema(Complete_checkoutApi as ZodiosApi)!;
const responseSchema = getResponseSchema(Complete_checkoutApi as ZodiosApi);
const headersSchema = getHeadersSchema(Complete_checkoutApi as ZodiosApi);
...
describe('complete_checkout request body Zod validation', () => {
...
describe('complete_checkout response Zod validation', () => {
...
describe('complete_checkout header Zod validation', () => {
