...
import { Update_checkoutApi } from '../update_checkout';
import {
  getRequestSchema,
  getResponseSchema,
  getHeadersSchema,
...
const requestSchema = getRequestSchema(Update_checkoutApi as ZodiosApi)!;
const responseSchema = getResponseSchema(Update_checkoutApi as ZodiosApi);
const headersSchema = getHeadersSchema(Update_checkoutApi as ZodiosApi);
...
describe('update_checkout request body Zod validation', () => {
...
describe('update_checkout response Zod validation', () => {
...
describe('update_checkout header Zod validation', () => {
