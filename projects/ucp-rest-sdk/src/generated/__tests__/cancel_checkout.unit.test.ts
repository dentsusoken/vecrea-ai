...
import { Cancel_checkoutApi } from '../cancel_checkout';
import {
  getResponseSchema,
  getHeadersSchema,
  type ZodiosApi,
...
const responseSchema = getResponseSchema(Cancel_checkoutApi as ZodiosApi);
const headersSchema = getHeadersSchema(Cancel_checkoutApi as ZodiosApi);
...
describe('cancel_checkout response Zod validation', () => {
...
describe('cancel_checkout header Zod validation', () => {
