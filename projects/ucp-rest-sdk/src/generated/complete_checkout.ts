...
const complete_checkout_Body = z
  .object({
    ucp: z
      .object({
      ...
      .object({
        instruments: z.array(
          z
            ...
            .passthrough()
            .and(z.object({ selected: z.boolean() }).partial().passthrough())
        ),
      })
      .partial()
      .passthrough()
  ...
  .and(
    z
      .object({ risk_signals: z.object({}).partial().passthrough() })
      .partial()
      .passthrough()
  );

export const schemas = {
  complete_checkout_Body,
};
...
export const Complete_checkoutApi = new Zodios(endpoints);
